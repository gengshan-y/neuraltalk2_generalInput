--[[
 - Filename:        workApr/neuraltalk2/misc/net_utils.lua
 - Date:            Jun 21 2016
...
-- Build a fc layer connecting features and LSTM
function net_utils.build_fc(opt)
  local backend = utils.getopt(opt, 'backend', 'cudnn')
  local encoding_size = utils.getopt(opt, 'encoding_size', 512)
  local input_size = utils.getopt(opt, 'input_size', 4096)
  ...
  cnn_part:add(nn.Linear(input_size, encoding_size))
